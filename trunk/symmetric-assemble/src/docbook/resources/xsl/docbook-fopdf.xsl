...
<!--
    ...
    Thanks are due to the Spring Project and Christian Bauer
    of the Hibernate project team for writing the original
    stylesheet upon which this one is based.
-->
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block font-family="Helvetica" font-size="12pt" padding-before="90mm">
                                <xsl:text>Copyright &copyright; 2007 - 2012 </xsl:text>
...
<!--###################################################
    ...
    <xsl:param name="body.font.small">10</xsl:param>
