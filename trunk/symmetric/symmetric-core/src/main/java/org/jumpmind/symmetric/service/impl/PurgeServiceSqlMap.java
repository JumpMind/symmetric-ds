...
"select min(batch_id) as min_id, max(batch_id) as max_id from $(prefixName)_outgoing_batch where                                           " + 
...
"select min(data_id) as min_id, max(data_id) as max_id from $(prefixName)_data where data_id < (select max(data_id) from $(prefixName)_data)   " );
...
"select node_id, min(batch_id) as min_id, max(batch_id) as max_id from $(prefixName)_incoming_batch where   " + 
