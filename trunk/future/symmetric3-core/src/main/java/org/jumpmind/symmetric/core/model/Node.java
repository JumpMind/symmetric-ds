...
public class Node implements Serializable {
    ...
    public Node(Parameters parameters, IDbDialect dbDialect) {
        ISqlTemplate template = dbDialect.getSqlTemplate();
        setNodeGroupId(parameters.getNodeGroupId());
        setExternalId(parameters.getExternalId());
        setDatabaseType(template.getDatabaseProductName());
        setDatabaseVersion(String.format("%s.%s", template.getDatabaseMajorVersion(),
                template.getDatabaseMinorVersion()));
        setSyncUrl(parameters.getSyncUrl());
        setSchemaVersion(parameters.get(Parameters.SCHEMA_VERSION));
    }

    public Node(String nodeId, String syncURL, String schemaVersion) {
        this.nodeId = nodeId;
    ...
    public boolean equals(Object n) {
        return n != null && n instanceof Node && nodeId != null
                && nodeId.equals(((Node) n).getNodeId());
    }
