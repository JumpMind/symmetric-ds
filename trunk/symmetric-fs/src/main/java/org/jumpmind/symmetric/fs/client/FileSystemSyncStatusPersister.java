...
public class FileSystemSyncStatusPersister extends
        AbstractJsonFileSystemPersister<SyncStatus, Node> implements ISyncStatusPersister {
    ...
    @Override
    protected String buildFileNameFor(Node key) {
        return String.format("%s.%s", key.getNodeId(), "status");
    }
}
