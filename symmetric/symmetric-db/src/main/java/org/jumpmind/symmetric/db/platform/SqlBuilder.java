package org.jumpmind.symmetric.db.platform;
...
import org.jumpmind.symmetric.db.alter.AddForeignKeyChange;
import org.jumpmind.symmetric.db.alter.AddIndexChange;
import org.jumpmind.symmetric.db.alter.AddPrimaryKeyChange;
import org.jumpmind.symmetric.db.alter.AddTableChange;
import org.jumpmind.symmetric.db.alter.ColumnAutoIncrementChange;
import org.jumpmind.symmetric.db.alter.ColumnDataTypeChange;
import org.jumpmind.symmetric.db.alter.ColumnDefaultValueChange;
import org.jumpmind.symmetric.db.alter.ColumnRequiredChange;
import org.jumpmind.symmetric.db.alter.ColumnSizeChange;
import org.jumpmind.symmetric.db.alter.IModelChange;
import org.jumpmind.symmetric.db.alter.ModelComparator;
import org.jumpmind.symmetric.db.alter.PrimaryKeyChange;
import org.jumpmind.symmetric.db.alter.RemoveColumnChange;
import org.jumpmind.symmetric.db.alter.RemoveForeignKeyChange;
import org.jumpmind.symmetric.db.alter.RemoveIndexChange;
import org.jumpmind.symmetric.db.alter.RemovePrimaryKeyChange;
import org.jumpmind.symmetric.db.alter.RemoveTableChange;
...
import org.jumpmind.symmetric.db.model.IndexColumn;
import org.jumpmind.symmetric.db.model.ModelException;
import org.jumpmind.symmetric.db.model.Reference;
import org.jumpmind.symmetric.db.model.Table;
import org.jumpmind.symmetric.db.model.TypeMap;
import org.jumpmind.symmetric.db.util.CallbackClosure;
import org.jumpmind.symmetric.db.util.MultiInstanceofPredicate;
...
public abstract class SqlBuilder {
     ...
     * <ol>
     * <li>
     * {@link org.jumpmind.symmetric.db.alter.RemoveForeignKeyChange} and
     * {@link org.jumpmind.symmetric.db.alter.RemoveIndexChange} come first to
     * allow for e.g. subsequent primary key changes or column removal.</li>
     * <li>{@link org.jumpmind.symmetric.db.alter.RemoveTableChange} comes after
     * the removal of foreign keys and indices.</li>
     * <li>These are all handled together:<br/>
     * {@link org.jumpmind.symmetric.db.alter.RemovePrimaryKeyChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.AddPrimaryKeyChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.PrimaryKeyChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.RemoveColumnChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.AddColumnChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.ColumnAutoIncrementChange} <br/>
     * {@link org.jumpmind.symmetric.db.alter.ColumnDefaultValueChange} <br/>
     * {@link org.jumpmind.symmetric.db.alter.ColumnRequiredChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.ColumnDataTypeChange}<br/>
     * {@link org.jumpmind.symmetric.db.alter.ColumnSizeChange}<br/>
     ...
     * <li>{@link org.jumpmind.symmetric.db.alter.AddTableChange}<br/>
     ...
     * <li>{@link org.jumpmind.symmetric.db.alter.AddForeignKeyChange} and
     * {@link org.jumpmind.symmetric.db.alter.AddIndexChange} come last after
    ...
    public String getTableName(Table table) {
        return shortenName(table.getName(), platform.getPlatformInfo().getMaxTableNameLength());
    }
