...
values('test_very_long_table_name_1234','test-root-group','test-node-group','testchannel', 1, 1, 1, null, null, null, null, null, '''test transaction id''', 1, 'chenson', current_timestamp,null,current_timestamp);
