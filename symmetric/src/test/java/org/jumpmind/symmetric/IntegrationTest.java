...
public class IntegrationTest extends AbstractIntegrationTest implements ITest {
    ...
    protected void initialLoad() {
        ...
        Assert.assertEquals(
                clientJdbcTemplate.queryForInt("select count(*) from sym_incoming_batch where status='ER'"), 0,
    ...
    private String printRootAndClientDatabases() {
        return " The root database is " + getRootDatabaseName() + " and the client database is "
    ...
    protected void turnOnNoKeysInUpdateParameter() {
        IParameterService clientParameterService = (IParameterService)getClientEngine().getApplicationContext().getBean(Constants.PARAMETER_SERVICE);
        IParameterService rootParameterService = (IParameterService)getRootEngine().getApplicationContext().getBean(Constants.PARAMETER_SERVICE);
    ...
    protected void testVirtualTransactionId() {
        ...
        if (getRootDbDialect().isTransactionIdOverrideSupported()) {
            Assert.assertEquals(rootJdbcTemplate.queryForObject(
