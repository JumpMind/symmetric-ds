<%@ page import="org.jumpmind.symmetric.grails.Channel; org.jumpmind.symmetric.grails.NodeGroupLink; org.jumpmind.symmetric.grails.NodeGroup; org.jumpmind.symmetric.grails.Router" %>
<html>
<head>
...
<g:render template="/common/createMenu"/>
  ...
  <g:form name="form" controller="router" action="save" method="post">
    <div class="dialog">
      <table>
        <tbody>
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: routerInstance, field: 'routerId', 'errors')}">
            <g:textField name="routerId" value="${routerInstance?.routerId}"/>
          </td>
        </tr>
