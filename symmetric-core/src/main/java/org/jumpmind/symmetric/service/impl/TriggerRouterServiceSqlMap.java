...
public class TriggerRouterServiceSqlMap extends AbstractSqlMap {
    ...
    public TriggerRouterServiceSqlMap(IDatabasePlatform platform,
        ...
        putSql("selectTriggerRoutersColumnList",
                "  tr.trigger_id, tr.router_id, tr.create_time, tr.last_update_time, tr.last_update_by, tr.initial_load_order, tr.initial_load_select, tr.initial_load_delete_stmt, tr.ping_back_enabled, tr.enabled, tr.cache_reload   ");
        ...
        putSql("insertTriggerRouterSql",
                ""
                        ...
                        + "  (initial_load_order,initial_load_select,initial_load_delete_stmt,ping_back_enabled,create_time,last_update_by,last_update_time,enabled,trigger_id,router_id, cache_reload)   "
                        + "  values(?,?,?,?,?,?,?,?,?,?,?)                                                                                                       ");

        putSql("updateTriggerRouterSql",
                ""
                        + "update $(trigger_router)                                                                             "
                        + "  set initial_load_order=?,initial_load_select=?,initial_load_delete_stmt=?,ping_back_enabled=?,last_update_by=?,last_update_time=?,enabled=?,cache_reload=?   "
