...
public class DataLoaderServiceSqlMap extends AbstractSqlMap {
    ...
    DataLoaderServiceSqlMap(IDatabasePlatform platform, Map<String, String> replacementTokens) {
        ...
        putSql("updateConflictSettingsSql", 
          "update $(schemaName)$(conflict) set                                                                        " +
        ...
        putSql("insertConflictSettingsSql", 
          "insert into $(schemaName)$(conflict) (                                                                      " +
          "source_node_group_id, target_node_group_id,                                                    " +
          "target_channel_id, target_catalog_name, target_schema_name, target_table_name,                 " +
        ...
        putSql("deleteConflictSettingsSql", "delete from $(schemaName)$(conflict) where conflict_id=?");
        
        putSql("deleteAllConflictSettingsSql", "delete from $(schemaName)$(conflict)");
        ...
        putSql("selectConflictSettingsSql",
                ...
                "detect_type, resolve_type, ping_back,                                                    " +
                "resolve_changes_only, resolve_row_only, detect_expression,                               " +
                "create_time, last_update_by, last_update_time, conflict_id from $(schemaName)$(conflict)              ");
        ...
        putSql("selectIncomingErrorSql",
        		...
        		"create_time, last_update_by, last_update_time from $(schemaName)$(incoming_error) where batch_id = ? and node_id = ?");
        ...
        putSql("selectCurrentIncomingErrorSql",
        		...
        		"from $(schemaName)$(incoming_error) e inner join $(schemaName)$(incoming_batch) b on b.batch_id = e.batch_id " +
...
"select max(last_update_time) from $(schemaName)$(conflict) where last_update_time is not null" );       

        putSql("insertIncomingErrorSql", 
        		"insert into $(schemaName)$(incoming_error) " +
        ...
        putSql("updateIncomingErrorSql",
        		"update $(schemaName)$(incoming_error) set resolve_data = ?, resolve_ignore = ? " +
