...
public class CacheManagerTest {
    ...
    public void loadFiltersCacheTest() {
        ...
        assertEquals(loadFilter.getTargetTableName(), loadFiltersCache.get(nodeGroupLink).get(loadFilter.getLoadFilterType()).get(loadFilter.getTargetTableName()).get(0).getTargetTableName());
        ...
        assertEquals(loadFilter.getTargetTableName(), loadFiltersCache.get(nodeGroupLink).get(loadFilter.getLoadFilterType()).get(loadFilter.getTargetTableName()).get(0).getTargetTableName());
        assertEquals(loadFilter2.getTargetTableName(), loadFiltersCache.get(nodeGroupLink).get(loadFilter2.getLoadFilterType()).get(loadFilter2.getTargetTableName()).get(1).getTargetTableName());
        ...
        assertEquals(loadFilter2.getTargetTableName(), loadFiltersCache.get(nodeGroupLink).get(loadFilter2.getLoadFilterType()).get(loadFilter2.getTargetTableName()).get(0).getTargetTableName());
    }
    ...
    public void transformCacheTest() {
        ...
        Map<NodeGroupLink, Map<TransformPoint, List<TransformTableNodeGroupLink>>> transformsCacheByNodeGroupLinkByTransformPoint =
                new HashMap<NodeGroupLink, Map<TransformPoint, List<TransformTableNodeGroupLink>>>();
