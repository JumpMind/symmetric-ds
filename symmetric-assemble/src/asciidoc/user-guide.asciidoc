...
v3.7
Copyright (C) 2007-2014 JumpMind, Inc
_Permission to use, copy, modify, and distribute the SymmetricDS User Guide Version 3.6 for any purpose and without fee is hereby granted in perpetuity, provided that the above copyright notice and this paragraph appear in all copies._
[preface]
:numbered!:
== Preface
...
and use its many features.  This version of the guide was generated on <?dbtimestamp format="Y-m-d"?> at <?dbtimestamp format="H:M:S"?>.
:numbered:

include::introduction.asciidoc[]
include::setup.asciidoc[]
include::configuration.asciidoc[]
include::manage.asciidoc[]
