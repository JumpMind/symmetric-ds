...
class DbExportUtilsTest {
    @Test
    void testExtractConfigurationStandalone_withNoTables() throws IOException {
        ...
        DbExportUtils.extractConfigurationStandalone(platform, List.of(), out);
