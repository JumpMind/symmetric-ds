...
insert into $(schemaName)sym_channel (channel_id, processing_order, max_batch_size, max_batch_to_send, contains_big_lob, enabled, description) values('testchannel', 1, 50, 50, 1, 1, null);
...
insert into $(schemaName)sym_node values ('00000', 'test-root-group', '00000', 1, null, null, '2.0', '2.0', null, null, current_timestamp, null, 0, 0, '00000', 'engine');
...
insert into $(schemaName)sym_trigger        (trigger_id,                source_table_name,    channel_id,                          tx_id_expression,  last_update_time,      create_time)
...
insert into $(schemaName)sym_trigger        (trigger_id,                source_table_name,    channel_id,                              sync_on_update_condition,                              sync_on_insert_condition,  last_update_time,      create_time)
...
insert into $(schemaName)sym_router  (router_id,source_node_group_id, target_node_group_id,   router_type, router_expression,       create_time,  last_update_time) 
...
insert into $(schemaName)sym_trigger        (trigger_id,                source_table_name,    channel_id, sync_on_update,sync_on_insert,sync_on_delete, last_update_time,      create_time)
...
insert into $(schemaName)sym_router  (router_id,source_node_group_id, target_node_group_id,     target_table_name,       create_time,  last_update_time) 
...
insert into $(schemaName)sym_trigger        (trigger_id,                source_table_name,    channel_id,    use_stream_lobs, last_update_time,      create_time)
...
insert into $(schemaName)sym_trigger        (trigger_id,                source_table_name,    channel_id,    use_capture_lobs, last_update_time,      create_time)
...
insert into $(schemaName)sym_trigger (trigger_id, source_table_name, channel_id,    last_update_time,  create_time)
                 values ('test_a',   'test_a',          'testchannel', current_timestamp, current_timestamp);
insert into $(schemaName)sym_trigger_router (trigger_id, router_id, initial_load_order, last_update_time,  create_time)
                        values ('test_a',   '1000',    1,                  current_timestamp, current_timestamp);

insert into $(schemaName)sym_trigger (trigger_id, source_table_name, channel_id,    last_update_time,  create_time)
                 values ('test_b',   'test_b',          'testchannel', current_timestamp, current_timestamp);
insert into $(schemaName)sym_trigger_router (trigger_id, router_id, initial_load_order, last_update_time,  create_time)
