...
public class MySqlBulkDatabaseWriterTest extends AbstractWriterTest {
    ...
    public void testInsert() {
        if (platform != null && platform instanceof MySqlDatabasePlatform) {
    ...
    public void testInsertWithSpecialEscape() {
        if (platform != null && platform instanceof MySqlDatabasePlatform) {
            String[] values = { getNextId(), "\\n\\N\\0\\r\\t\\", "\n\r\t\b\f\0", "\\x31\\x32\\x33", "\\061\\062\\063",
    ...
    public void testInsertWithUnicode() {
        if (platform != null && platform instanceof MySqlDatabasePlatform) {
            String unicode = "\u007E\u00A7\u2702\u28FF\uFFE6\uFFFC\uFFFF";
            String[] values = { getNextId(), unicode, unicode, unicode, unicode, "2007-01-02 00:00:00.000",
    ...
    protected String encode(String str) {
        return new String(Base64.encodeBase64("string with space in it".getBytes()));
    }
