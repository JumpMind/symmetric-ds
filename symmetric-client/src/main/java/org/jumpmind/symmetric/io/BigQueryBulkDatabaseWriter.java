...
public class BigQueryBulkDatabaseWriter extends CloudBulkDatabaseWriter {
    ...
    public void loadToCloudDatabase() throws SQLException {
        try {
            ...
            WriteChannelConfiguration writeChannelConfiguration = WriteChannelConfiguration.newBuilder(tableId).setFormatOptions(csvOptions).setAutodetect(
                    false).setDestinationTable(tableId).build();
