 ...
 */
public class PostgresJdbcTableReader extends JdbcTableReader {
     ...
     */
    public PostgresJdbcTableReader(IJdbcDbDialect dbDialect) {
        super(dbDialect);
    ...
    protected int mapJdbcTypeForColumn(int typeCode, Map<String, Object> values) {
        ...
        if (typeName != null && typeName.equalsIgnoreCase("ABSTIME")) {
            ...
            return super.mapJdbcTypeForColumn(typeCode, values);
        }
    }
        ...
        if (table != null) {
            ...
            for (int columnIdx = 0; columnIdx < table.getColumnCount(); columnIdx++) {
                ...
                if (column.isAutoIncrement() && !column.isPrimaryKey()) {
                    String indexName = table.getTableName() + "_" + column.getName() + "_key";
