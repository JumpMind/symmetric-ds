...
public class Hex {
     ...
     * @return An integer @ Thrown if ch is an illegal hex character
     */
     ...
     * @return A char[] containing hexidecimal characters @ Thrown if the given
     *         object is not a String or byte[]
     * @see #encodeHex(byte[])
     */
