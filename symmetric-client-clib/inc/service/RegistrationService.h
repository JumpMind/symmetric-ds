 ...
 * under the License.
 */
#ifndef SYM_REGISTRATION_SERVICE_H
#define SYM_REGISTRATION_SERVICE_H
...
typedef struct {
    ...
    void (*register_with_server)(void *this);
    unsigned short (*is_registered_with_server)(void *this);
