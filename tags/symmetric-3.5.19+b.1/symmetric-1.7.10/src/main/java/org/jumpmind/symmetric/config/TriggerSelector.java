...
public class TriggerSelector {
    ...
    public TriggerSelector(Collection<Trigger> triggers, String channelId, String targetNodeGroupId) {
    ...
    public List<Trigger> select() {
        List<Trigger> filtered = new ArrayList<Trigger>();
        for (Trigger trigger : triggers) {
            if (trigger.getChannelId().equals(channelId)
                    && (targetNodeGroupId == null || trigger.getTargetGroupId().equals(targetNodeGroupId))) {
