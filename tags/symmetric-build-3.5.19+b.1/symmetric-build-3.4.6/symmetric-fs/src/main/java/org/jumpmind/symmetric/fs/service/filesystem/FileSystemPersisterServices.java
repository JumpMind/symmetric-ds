...
public class FileSystemPersisterServices implements IPersisterServices {
    ...
    public FileSystemPersisterServices(String statusDirectory, String configDirectory) {
        syncStatusPersister = new FileSystemSyncStatusPersister(statusDirectory);
        syncConfigCollectionPersister = new FileSystemSyncConfigCollectionPersister(configDirectory);
        directorySpecSnapshotPersister = new FileSystemDirectorySpecSnapshotPersister(statusDirectory);
    }

    public IDirectorySpecSnapshotPersister getDirectorySpecSnapshotPersister() {
        return directorySpecSnapshotPersister;
    }
    
    public ISyncConfigCollectionPersister getSyncConfigCollectionPersister() {
        return syncConfigCollectionPersister;
    }
    
    public ISyncStatusPersister getSyncStatusPersister() {
        return syncStatusPersister;
    }
