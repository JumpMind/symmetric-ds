...
public abstract class AbstractDriverBasedDataSource extends AbstractDataSource {
    ...
    /**
     * Specify arbitrary connection properties as key/value pairs, to be passed
     * to the Driver.
     * <p>
     * Can also contain "user" and "password" properties. However, any
     * "username" and "password" bean properties specified on this DataSource
     * will override the corresponding connection properties.
     * 
     * @see java.sql.Driver#connect(String, java.util.Properties)
     */
    ...
    /**
     * Build properties for the Driver, including the given username and
     * password (if any), and obtain a corresponding Connection.
     * 
     * @param username
